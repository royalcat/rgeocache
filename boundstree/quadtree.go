...
func (b *Bounds[Data]) IsPoint() bool {
...
func (b *Bounds[Data]) Intersects(a Bounds[Data]) bool {
...
func (qt *Quadtree[Data]) TotalNodes() int {
...
func (qt *Quadtree[Data]) split() {
	...
	//top right node (0)
	qt.Nodes = append(qt.Nodes, Quadtree[Data]{
		Bounds: Bounds[Data]{
			X:      x + subWidth,
			Y:      y,
			Width:  subWidth,
		...
		Level:      nextLevel,
		Objects:    make([]Bounds[Data], 0),
		Nodes:      make([]Quadtree[Data], 0, 4),
	})
...
func (qt *Quadtree[Data]) getIndex(pRect Bounds[Data]) int {
...
func (qt *Quadtree[Data]) Insert(pRect Bounds[Data]) {
...
func (qt *Quadtree[Data]) Retrieve(pRect Bounds[Data]) []Bounds[Data] {
...
func (qt *Quadtree[Data]) RetrievePoints(find Bounds[Data]) []Bounds[Data] {

	var foundPoints []Bounds[Data]
...
func (qt *Quadtree[Data]) RetrieveIntersections(find Bounds[Data]) []Bounds[Data] {

	var foundIntersections []Bounds[Data]
...
func (qt *Quadtree[Data]) Clear() {

	qt.Objects = []Bounds[Data]{}
